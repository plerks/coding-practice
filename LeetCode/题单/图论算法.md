...
## 另外一些 bfs 搜索最短路问题
根据状态 bfs ，搜索出最短路。出发点就是暴力搜索，但是有些能剪枝一下。

也可以用 dfs / A* 去搜索。

* [LeetCode1284. 转化为全零矩阵的最少反转次数](https://leetcode.cn/problems/minimum-number-of-flips-to-convert-binary-matrix-to-zero-matrix/) (状态搜索 + 位优化)

* [LeetCode847. 访问所有节点的最短路径](https://leetcode.cn/problems/shortest-path-visiting-all-nodes/) (旅行商问题，位优化，dp)

* [LeetCode854. 相似度为 K 的字符串](https://leetcode.cn/problems/k-similar-strings/) (bfs 搜索 + 剪枝，循环节)

* [LeetCode127. 单词接龙](https://leetcode.cn/problems/word-ladder/) (双向 bfs)

* [LeetCode488. 祖玛游戏](https://leetcode.cn/problems/zuma-game/) (有篇题解有个复杂但是效率极高的解法)

* [LeetCode1345. 跳跃游戏 IV](https://leetcode.cn/problems/jump-game-iv/) (访问后删除节点以达到 O(n))
...
* [LeetCode1786. 从第一个节点出发到最后一个节点的受限路径数](https://leetcode.cn/problems/number-of-restricted-paths-from-first-to-last-node/) (Dijkstra + 拓扑序dp)
