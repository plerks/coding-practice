...
public:
    ...
    */
    ...
    int maximizeWin_implementation2(vector<int>& prizePositions, int k) {
        int n = prizePositions.size();
        int l = 0;
        int ans = 0;
...
int main(int argc, char const *argv[]) {
    ...
    cout << solu.maximizeWin_implementation2(*new vector<int>{1,1,2,2,3,3,5}, 2) << endl;
    return 0;
}