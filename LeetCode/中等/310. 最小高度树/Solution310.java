...
public class Solution310 {
    ...
    */
    ...
    若不然，则p1，p2中的较大者p和q1，q2中的较大者q构成的路径pq将会是更长的路径(容易看出这里pq一定是简单路径，因为p，q分列r的两边，节点无重合，且p，q各自是简单路径，则pq也是简单路径)，与x，y和u，v同为最长路径矛盾。
    这里由于r是正中节点，则|p1|=|q1|，其实是有|p1|=|p2|=|q1|=|q2|的。
